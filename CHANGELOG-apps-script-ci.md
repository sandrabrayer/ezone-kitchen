...
deployment, which changes the `/exec` URL and breaks consumers). This automates
the exact-and-only-correct path.

## What changed
- **`.clasp.json`** (new): `scriptId` of the Kitchen Apps Script project;
